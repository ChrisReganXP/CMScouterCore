    ...
    internal class CoreRater : IPlayerRater
    {
        ...
        */
        ...
        public ScoutingInformation GetRatings(Player player)
        {
            ...
            positionRatings.Add(GetRatingsForPosition(player, PlayerType.GoalKeeper, offFieldRating));
            positionRatings.Add(GetRatingsForPosition(player, PlayerType.RightBack, offFieldRating));
            positionRatings.Add(GetRatingsForPosition(player, PlayerType.CentreHalf, offFieldRating));
            positionRatings.Add(GetRatingsForPosition(player, PlayerType.LeftBack, offFieldRating));
            positionRatings.Add(GetRatingsForPosition(player, PlayerType.RightWingBack, offFieldRating));
            positionRatings.Add(GetRatingsForPosition(player, PlayerType.DefensiveMidfielder, offFieldRating));
            positionRatings.Add(GetRatingsForPosition(player, PlayerType.LeftWingBack, offFieldRating));
            positionRatings.Add(GetRatingsForPosition(player, PlayerType.RightMidfielder, offFieldRating));
            positionRatings.Add(GetRatingsForPosition(player, PlayerType.CentralMidfielder, offFieldRating));
            positionRatings.Add(GetRatingsForPosition(player, PlayerType.LeftMidfielder, offFieldRating));
            positionRatings.Add(GetRatingsForPosition(player, PlayerType.RightWinger, offFieldRating));
            positionRatings.Add(GetRatingsForPosition(player, PlayerType.AttackingMidfielder, offFieldRating));
            positionRatings.Add(GetRatingsForPosition(player, PlayerType.LeftWinger, offFieldRating));
            positionRatings.Add(GetRatingsForPosition(player, PlayerType.CentreForward, offFieldRating));
        ...
        private PositionRating GetRatingsForPosition(Player player, PlayerType type, byte offFieldRating)
        {
            ...
            {
                var rating = GetRatingForTypeAndRole(player, type, role);
                rating.Rating = AdjustScoreForPosition(player, type, rating.Rating, rating.Debug);
                rating.Rating = ApplyOffFieldAdjustment(rating.Rating, offFieldRating, rating.Debug);
        ...
        private RoleRating GetRatingForTypeAndRole(Player player, PlayerType type, Roles role)
        {
            RatingRoleDebug roleDebug = new RatingRoleDebug();
            var rating = CalculateRating(player, type, role, ref roleDebug);
            //var adjustedForPosition = AdjustScoreForPosition(player, type, attributeRating, roleDebug);

            return new RoleRating() { Rating = rating, Role = role, Debug = roleDebug, };
        }
